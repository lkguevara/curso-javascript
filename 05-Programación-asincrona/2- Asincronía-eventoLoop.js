...
// * #2. Conceptos claves:
    /*
        *Procesamiento single thread (un hilo) y multithread (varios hilos): 
    ...
    */
    ...
    /*
        *Operaciones de CPU y de Entrada y Salida: 
            Operaciones CPU: Aquellas que pasan el mayor tiempo consumiendo Procesos del CPU, por ejemplo, la escritura de ficheros (loop infinitos).
...
// *#3. Ejemplos
    ...
    //* Código síncrono y bloqueante --> (cada operación se realiza de una, bloqueando el flujo del hilo principal, brindando una respuesta hasta que finalicen todas las operaciones).
